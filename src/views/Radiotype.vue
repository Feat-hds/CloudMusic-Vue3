                ...
                <div class="radiotype">
                    <div class="recommend">
                        <div class="item_container" v-for="(item,index) in radiolist" :key="index">
                            <myitem :shadow="false" :imgurl="`${item.picUrl}?param=130y130`" :routemode="true" :router="{name:'radiodetail',params:{id:item.id}}" class="item" />
                            <div class="info">
                                <span class="title">{{item.name}}</span>
                                <div class="brief text">{{item.desc}}</div>
                                <div class="number text">声音:<playnumber :number="item.programCount"/> 收藏:<playnumber :number="item.subCount"/></div>
                            </div>
                        </div>
                    </div>
                </div>
