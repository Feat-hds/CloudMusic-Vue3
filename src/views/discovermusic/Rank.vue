            ...
            <part title="官方榜">
                <div class="sort_rank_list">
                    <div class="item_container" v-for="(item, index) in toplist" :key="index">
                        <myitem :hoveranim="false" :shadow="false" :imgurl="`${item.coverImgUrl}?param=150y150`"
                            :routemode="true" :router="{ name: 'musiclistdetail', params: { id: item.id } }" class="item">
                        </myitem>
                ...
                <div class="rank_list">
                    <div class="item_container" v-for="(item, index) in ranklist" :key="index">
                        <Myitem :routemode="true" :router="{ name: 'musiclistdetail', params: { id: item.id } }"
                            :imgurl="`${item.coverImgUrl}?param=150y150`" class="item" :number="item.playCount"></Myitem>
