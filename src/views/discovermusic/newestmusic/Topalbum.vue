        ...
        <div class="group">
            <div class="hotcat_container">
                <div  v-for="(item,index) in catlistarea" :key="index" class='sort_container'>
                    <span @click="handleClick(item)" class="sort_child" :class="{'is-active':item.id===currentarea}">{{item.name}}</span>
                </div>
            </div>
            <div class="hotcat_container">
                <div  v-for="(item,index) in catlisttype" :key="index" class='sort_container'>
                    <span @click="handleClick(item)" class="sort_child" :class="{'is-active':item.id===currenttype}">{{item.name}}</span>
                </div>
            </div>
        </div>
        <part title="本周新碟">
...
export default {
    ...
    setup(){
        ...
        onBeforeMount(async ()=>{
            try{
                // await gettopalbum(currentarea.value,currenttype.value)
