    ...
    <div class="loading" v-if="!complete">
      ...
      <div v-if="complete&&dataok">
          ...
          >
            ...
            <el-table-column show-overflow-tooltip min-width="60">
              <template v-slot="{row}">
                <mytitle size="small" color="light" :routemode="true" :router="{name:'userprofile',params:{id:row.dj.userId}}" >by:{{row.dj.nickname}}</mytitle>
              </template>
            </el-table-column>
...
export default {
    ...
    setup(){
      ...
      async function getsearchradio(keyword,limit,offset){
        ...
        //   if(to.name==='searchradio'){
        //     complete.value=false;
        //     dataok.value=true;
        //     try{
        //       if(route.query.keyword){
        //         await getsearchradio(route.query.keyword,30,0);
        //       }
